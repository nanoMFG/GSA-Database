...
vars_dict = {
    "DEV_DATABASE_URL": "",
    "DEV_DATABASE_ARGS": "",
    "DEV_DATABASE_URL_READ": "",
    "DEV_DATABASE_ARGS_READ": "",
    "DEV_DATABASE_URL_WRITE": "",
    "DEV_DATABASE_ARGS_WRITE": "",
    "DEV_DATABASE_URL_ADMIN": "",
    "DEV_DATABASE_ARGS_ADMIN": "",
    "TEST_DATABASE_URL": "",
    "TEST_DATABASE_ARGS": "",
    "TEST_DATABASE_URL_READ": "",
    "TEST_DATABASE_ARGS_READ": "",
    "TEST_DATABASE_URL_WRITE": "",
    "TEST_DATABASE_ARGS_WRITE": "",
}
...
class TestConfig:
    ...
    def test_Secrets(self, unset_env_vars, make_file_secrets):
        conf = gresq.config.Config(
            prefix=config_prefix,
            debug=True,
            dbconfig_file=tmp_secrets_file,
            try_secrets=True,
        )
    ...
    def test_env_takes_precident(
        self, unset_env_vars, make_file_secrets, make_env_secrets
    ):
        conf = gresq.config.Config(
            prefix=config_prefix,
            debug=True,
